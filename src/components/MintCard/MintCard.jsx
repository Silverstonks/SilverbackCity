      ...
      <div className="mint-card row">
        <div className="col-12 col-md-6 mint-card-details">
          ...
          <div className="mint-card-price-container presale">
            ...
            &nbsp;
            <span className="mint-card-price font-weight-bold">{t('price')}</span>
            &nbsp;
            <span>{t('coin')}</span>
          </div>
          <div className="mint-card-price-container text-white">
            <span className="mint-card-price-label color-white">{t('launchLabel')}</span>
            &nbsp;
            <span className="mint-card-price text-white">{t('launchPrice')}</span>
            &nbsp;
            <span>{t('coin')}</span>
          </div>
