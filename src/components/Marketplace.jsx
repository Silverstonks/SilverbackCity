...
const Marketplace = () => {
    return (
        <div className="container">
            <div className="row">
                <div className="marketplace col-9 ml-auto my-5">
                    <p className="h4 my-auto py-5">
...
<div className="col-1"></div>
                <div className="landlord col-5  my-5">
                    ...
                    <div className="my-5" ><img src={LandlordImg} alt="" /></div>
                    <div>
...
<div className="col-1"></div>
                <div className="meta col-5 my-5">
                    <div className="meta-title">
                        <span className="h3 title-text">META ADVERTISING </span>
                        <p className="my-auto py-5"> Get yoor Advertising</p>
                    </div>
                    <div className="my-5"><img className="my-3" src={MetaImg} alt="" /></div>
