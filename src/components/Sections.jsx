...
const Sections = () => {
    return (
        <div className="container mx-auto">
            <SectionItemImgRight id="bidsarena" icon={BidsarenaIcon} title="BIDSARENA" buttonText={"COMING SOON"} img={BidsarenaImg} text="Win purchasing power with our first Play 2 Earn game. Use your bids to win your favorite products at incredible prices. Every auction starts at $0.00 and has a timer. Each bid increases the price by $0.01 and resets the timer by 10 seconds. The last bidder to place a bid before the time runs out wins the item at a price much lower than the regular retail price." />
            <div className='d-flex justify-content-end '>
                <img src={DotsDecoration} alt="" className="mr-5 my-4"/>
            </div>
            <SectionItemImgLeft id="silvershop" icon={SilverShopIcon} title="SILVER SHOP" buttonText={"INVEST IN SILVER"} img={SilverShopImg} text="Buy physical silver in Silver Stonks’ Silver Shop to protect yourself against inflation. We take a spin on traditional bullion by making products that appeal to a wider demographic, connecting blockchain with the traditional world of investing in precious metals. Each silver product is tied to a digital certificate of authenticity. Owning our silver bars allows you to claim certificates of authenticity in your digital wallet, which can then be used to earn interest on your silver every month in SSTX." />
            <SectionItemImgRight id="vault" icon={VaultIcon} title="THE VAULT" buttonText={"COMING SOON"} img={VaultImg} text="In the Vault you can store your SSTX tokens and digital silver certificates to earn interest in SSTX. There are three ways you can earn interest: 
            ...
            <SectionItemImgLeft id="foundry" icon={FoundryIcon} title="FOUNDRY" buttonText={"COMING SOON"} img={FoundryImg} text="Each Silverback holder will have access to the Underground Lounge, an exclusive chatroom to talk about the latest news from everything in crypto to the precious metals market. " />
        </div>
    );
}
        ...
        <div className="row">
            ...
            <div className="section-item-img-right col-12 m-auto ">
                ...
                <div className="row flex-column-reverse flex-md-row ">
                    ...
                    <div className="col-md-6 d-flex flex-column justify-content-between pr-5 my-5">
        ...
        <div className="row ">
            ...
            <div className="section-item-img-left col-12 m-auto ">
                ...
                <div className="row flex-column-reverse flex-md-row">
                    ...
                    <div className="col-md-6 d-flex flex-column justify-content-between pl-5 my-5">
