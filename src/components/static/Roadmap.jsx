				...
				<div className="container">
					<div className="row mb-5">
						<div className="col-md-12">
							<div className="w-100">
								...
								<p
									className="txt-color-white fs-16"
									data-aos="fade-up"
									data-aos-delay="1000"
									data-aos-offset="50"
					...
					<div className="row no-gutters">
						...
						<div
							...
							data-aos-duration="1000"
						>
							<h3 className="txt-color-mint mb-4 td-1">
								{t("Quarter.Q221.quarter")}
							</h3>
							<div className="road-map-card text-center solid-top mobile-solid-right mb-5">
								<div className="dot">
						...
						<div
							...
							data-aos-duration="1000"
						>
							<h3 className="txt-color-mint mobile-solid-right mb-4 td-1">
								{t("Quarter.Q321.quarter")}
							</h3>
							<div className="road-map-card text-center solid-top mobile-solid-left mb-5">
								<div className="dot">
									<div className="dot-solid"></div>
								</div>
						...
						<div
							...
							data-aos-duration="1000"
						>
							<h3 className="txt-color-mint mobile-solid-left mb-4 td-1">
								{t("Quarter.Q421.quarter")}
							</h3>
						...
						>
							<h3 className="txt-color-mint mobile-solid-left mb-4 td-1">
								{t("Quarter.Q222.quarter")}
							</h3>
							<div className="road-map-card text-center mobile-solid-right solid-top mb-5">
								<div className="dot">
									<div className="dot-solid"></div>
								</div>
						...
						<div
							...
							data-aos-duration="1000"
						>
							<h2 className="txt-color-mint mobile-solid-right td-1 mb-special-1">
								{t("Quarter.Q122.quarter")}
							</h2>
							<div className="road-map-card text-center mobile-solid-left solid-top mb-5">
								<div className="dot">
									<div className="dot-solid"></div>
								</div>
						...
						>
							<h3 className="txt-color-mint mobile-solid-left mb-4 td-1">
								{t("Quarter.Q422.quarter")}
							</h3>
							<div className="road-map-card text-center mobile-dodded-right dash-top mb-5">
						...
						<div
							...
							data-aos-duration="1000"
						>
							<h3 className="txt-color-mint mb-4 mobile-dodded-right td-1">
								{t("Quarter.Q123.quarter")}
							</h3>
							<div className="road-map-card text-center mobile-solid-left dash-top mb-5">
								<div className="dot-solid-only"></div>
						...
						<div
							...
							data-aos-duration="1000"
						>
							<h3 className="txt-color-mint mb-4 mobile-solid-left td-1">
								{t("Quarter.Q223.quarter")}
							</h3>
							<div className="road-map-card text-center mobile-dodded-right mobile-dodded-bottom dash-top mb-5">
								<div className="dot-solid-only"></div>
