						...
						<ul>
							...
							>
								<p className="d-flex">
									<img
										src={PropertyHolders}
										alt="This is an image of the Property Holders logo."
										width="20px"
										className="mr-2"
									/>{" "}
							...
							<li className="py-1" onClick={() => scrollTo("nft-lab", 100)}>
								<p className="d-flex">
									<img
										src={NftLab}
										alt="This is an image of the Silver Stonks NFT lab, with a Troop of Silverback City in the making."
										width="25px"
										className="mr-2"
									/>
									{t("link.nftlab")}
							...
							<li className="py-1" onClick={() => scrollTo("vault", 100)}>
								<p className="d-flex">
									<img
										src={Vault}
										alt="This is an image of the Silver Stonks digital vault for staking SSTX tokens or precious metals."
										width="20px"
										className="mr-2"
									/>
									{t("link.vault")}
						...
						<ul>
							<li className="py-1" onClick={() => scrollTo("lounge", 100)}>
								<p className="d-flex">
									<img
										src={Lounge}
										alt="This is an image of the Silver Stonks underground lounge in Silverback City. Join the DIscord to be a part of the chat."
										width="20px"
										className="mr-2"
									/>
							...
							<li className="py-1" onClick={() => scrollTo("exchange", 100)}>
								<p className="d-flex">
									<img
										src={Exchange}
										alt="This is an image of the Silver Stonks exchange where you can purchase SSTX."
										width="20px"
										className="mr-2"
									/>
							...
							<li className="py-1" onClick={() => scrollTo("silvershop", 100)}>
								<p className="d-flex">
									<img
										src={Ecommerce}
										alt="This is an image of the Silver Stonks shop that sells precious metals."
										width="20px"
										className="mr-2"
									/>
							...
							>
								<p className="d-flex">
									<img
										src={Meta}
										alt="This is an image of the Silver Stonks meta advertising in the Silverback City metaverse."
										width="20px"
										className="mr-2"
									/>
			...
			<div className="container-fluid">
				<div className="container-xl py-4">
					<div className="row justify-content-between">
						<div className="col-md-4 txt-color-white text-center text-md-left">
							{t("copyright")}
						</div>
						<div className="col-md-4 text-center txt-color-white">
							<a
								href="https://silverstonks.io/privacy.html"
							...
							<a
								href="https://silverstonks.io/terms.html"
								className="txt-color-white "
							>
